...
{
    public class UserRemovePermissionOperationTest
    {
        private readonly ILogger<UserRemovePermissionOperation> _logger;
        private readonly IUserAggregationStore _store;
        private readonly UserRemovePermissionOperation _operation;
        private readonly Fixture _fixture;

        public UserRemovePermissionOperationTest()
        {
            _fixture = new Fixture();
            _store = Substitute.For<IUserAggregationStore>();
            _logger = Substitute.For<ILogger<UserRemovePermissionOperation>>();
            
            _operation = new UserRemovePermissionOperation(_store, _logger);
        }

        [Fact]
        public async Task Execute_Should_ReturnError_When_UserNotFound()
        {
            var request = _fixture.Create<UserRemovePermission>();
