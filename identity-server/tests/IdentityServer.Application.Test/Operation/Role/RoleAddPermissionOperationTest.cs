...
{
    public class RoleAddPermissionOperationTest
    {
        private readonly ILogger<RoleAddPermissionOperation> _logger;
        private readonly IRoleAggregationStore _store;
        private readonly RoleAddPermissionOperation _operation;
        private readonly Fixture _fixture;

        public RoleAddPermissionOperationTest()
        {
            _fixture = new Fixture();
            _store = Substitute.For<IRoleAggregationStore>();
            _logger = Substitute.For<ILogger<RoleAddPermissionOperation>>();
            
            _operation = new RoleAddPermissionOperation(_store, _logger);
        }

        [Fact]
        public async Task Execute_Should_ReturnError_When_RoleNotFound()
        {
            var request = _fixture.Create<RoleAddPermission>();
