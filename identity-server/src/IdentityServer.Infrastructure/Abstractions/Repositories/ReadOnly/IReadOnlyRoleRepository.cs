...
namespace IdentityServer.Infrastructure.Abstractions.Repositories.ReadOnly
{
    public interface IReadOnlyRoleRepository
    {
        ...
        Task<bool> ExistAsync(string name, CancellationToken cancellationToken = default);
        IAsyncEnumerable<Role> GetAllAsync([EnumeratorCancellation] CancellationToken cancellationToken = default);
    }
}